...
async def _(event):
    ...
    packname = f"þ "
    packshortname = f"þ "  # format: þ

    await event.edit("Kanging this fucker's sticker. Please Wait!")
    ...
    async with borg.conversation("@Stickers") as bot_conv:
        ...
        with BytesIO(file) as mem_file, BytesIO() as sticker:
            ...
            sticker.seek(0)
            uploaded_sticker = await borg.upload_file(sticker, file_name="@AlphaCU_Sticker.png")
