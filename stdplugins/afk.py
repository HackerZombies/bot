...
async def on_afk(event):
    ...
    if borg.storage.USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        msg = None
        message_to_reply = f"Sorry! My boss is AFK since {afk_since} " + \
            f"and He will be back soon don't worry he will reply you as soon as possible\n__Reason:__ {reason}" \
            if reason \
            else f"Sorry! My boss is AFK since {afk_since} and He will be back soon don't worry he will reply you as soon as possible."
